...
if __name__ == '__main__':
    originalImagePath = '/Users/dimitrichrysafis/Desktop/card.png'  # Replace with the path to the original image
    bwImagePath = '/Users/dimitrichrysafis/Desktop/card.png'  # Replace with the path to save the black-and-white image
    modelPath = 'cardClassifier.pth'
    classNamesPath = 'classNames.txt'

    convertToBlackAndWhite(originalImagePath, bwImagePath)
    predictedClass = predictCard(bwImagePath, modelPath, classNamesPath)
